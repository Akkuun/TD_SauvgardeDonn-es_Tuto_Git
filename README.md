...
Un ticket est composé d'un titre, une description, un auteur, un identifiant et un statut (fermé ou ouvert).Un ticket peut être crée depuis l'interface de Git/GitHub en ligne : 
